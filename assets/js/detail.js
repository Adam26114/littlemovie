...
//return onlyll trailers and teasers as array
const filterVideos = function (videoList){
    return videoList.filter(({ type, site }) => (type === "Trailer" || type === "Teaser") && site === "YouTube" );
}

fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${api_key}&append_to_response=casts%2Cvideos%2Cimages%2Creleases`,function(movie){
    ...
    document.title = `${title} - Panda Movie`;
    ...
    movieDetail.innerHTML = `
        ...
        <div class="detal-box"> 
            ...
            <div class="detail-content">
                ...
                <div class="meta-list">
                    <div class="meta-item">
                        <img src="./assets/img/star.png" width="20" height="20" alt="rating"/>
                    ...
                    <div class="separatot"></div>

                    <div class="meta-item">${release_date.split("-")[0]}</div>

                    <div class="meta-item card-bradge ">${certification}</div>
                </div>
...
const addSuggestedMovies = function ({ results: movieList }, title) {
    ...
    movieListElem.areaLabel = "You May Also Like";
